  ...
  return (
    <>
      <Block factor={1} offset={0}>
        <Block factor={1.2}>
          <Dom
            position={mobile ? [-w / 3.2, 1.0, -1] : [-w / 3.2, 1.1, -1]}
            className="frontend"
          >
            Frontend{mobile ? <br /> : " "}
          </Dom>
        ...
        <Block factor={1.0}>
          <Dom position={[-w / 3.2, -w * 0.08 + 0.25, -1]}>
            The year 2018.{mobile ? <br /> : " "}Beginning of this journey.
          </Dom>
        </Block>
      </Block>
      <Block factor={1.2} offset={5.7}>
        ...
        <Block factor={1.0}>
          <Dom
            position={[mobile ? -w / 2.5 : -w / 3.0, -w * 0.5 + 0.25, -1]}
            className="quote"
          >
            A user interface is like a joke. {mobile ? <br /> : <br />}If you
            have to explain it,{mobile ? <br /> : <br />} it’s not that good...
          </Dom>
        </Block>
      </Block>
      ...
      <Block factor={1.25} offset={8}>
        ...
        <Dom
          ...
          position={[mobile ? -w / 1.8 : -w / 3.5, -canvasHeight / 1.9, 0]}
        >
          <p className="copyright_home">
            {`All rights reserved - ${today.getFullYear()}`}{" "}
            <i className="far fa-copyright"></i> devendra saroj.
          </p>
        </Dom>
      </Block>
    </>
    ...
    <>
      ...
      <div className="frame">
        ...
        <div className="frame__links">
          <a className="frame__link" href="#" onClick={showAboutSection}>
            {" "}
            About{" "}
          </a>
          <a
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            href="mailto:devendrasaroj97@gmail.com"
            children="Mail"
          />
          <a
            className="frame__link"
            target="_blank"
            rel="noopener noreferrer"
            href="https://www.linkedin.com/in/devendra-saroj-78187b111/"
          >
            {" "}
            LinkedIn{" "}
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            href="https://github.com/devendraSaroj"
          >
            {" "}
            GitHub{" "}
          </a>
        ...
        <div className="frame__nav__right">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            href="https://play.google.com/store/apps/details?id=com.wordgamer.djsde.splashactivity"
            children="01"
          />
          <a
            className="frame__link"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            href="https://play.google.com/store/apps/details?id=com.rathh.app"
            children="03"
          />
          <a
            className="frame__link"
            target="_blank"
            rel="noopener noreferrer"
            href="https://github.com/devendraSaroj/TalkFree"
            children="04"
          />
          <a
            className="frame__link"
            target="_blank"
            rel="noopener noreferrer"
            href="https://devendrasaroj.github.io/hennge/"
            children="05"
          />
          <a
            className="frame__link"
      ...
      <section className="about-container" id="about_section">
        <div className="about">
          ...
          <div className="detail">
            <p>{`My name is Devendra, I am ${getAge(
              "10-11-1997"
            )} years old and I am Front-end developer.`}</p>
            <p>
              In order to introduce myself, it seems to me more sensible to skip
              the classical entry through which I present my academic as well as
              professional career.
            </p>
            <p>
              A "Need For Speed" fanatic, my friend had no choice but to cruelly
              uninstall it from his system. Yep! I used to play on his system as
              my lappy lacked the specs then. After that I had no choice but to
              propell me to a new hobby, the surfing over Web technologies.
            </p>
            <p>
              So it was by being deprived of an entertainment that I discovered
              another one - that quickly turned into a passion and then a
              profession.
            </p>
            <p>
              Beyond the professional dimension that front-end development has
              taken in my life, it remains one of my passions, that I cultivate
              tirelessly in my spare time.
            </p>
